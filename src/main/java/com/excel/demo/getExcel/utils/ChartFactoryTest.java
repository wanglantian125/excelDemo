...
public class ChartFactoryTest {
	...
	public static void main(String[] args) throws Exception {
		...
		testCreatePieChart();
		testCreateLineChart();
		testCreateStackedBarChart();
	}
	public static void testCreateBarChart() throws Exception {
		// 标注类别
		String[] categories = { "△s", "△t", "△e", "△p", "May", "Jun",
		...
		File file = new File("D:\\11111.jpeg");
		int width = 1024;
		int height = 420;
	...
	public static void testCreatePieChart() throws Exception {
		...
		File file = new File("D:\\2222222233.jpg");
		int width = 1024;
		int height = 420;
		ChartUtilities.saveChartAsJPEG(file, chart, width, height);
	}
	 ...
	 * @throws Exception
	 */
	public static void testCreateLineChart() throws Exception {
		// 标注类别
	...
	public static void testCreateStackedBarChart() throws Exception {
		// 标注类别
		String[] categories = { "Jan", "Feb", "Mar", "Apr", "May", "Jun",
				"Jul", "Aug", "Sep", "Oct", "Nov", "Dec" };
		Vector<Serie> series = new Vector<Serie>();
		...
		File file = new File("D:\\556252.jpg");
		int width = 1024;
		int height = 420;
		ChartUtilities.saveChartAsJPEG(file, chart, width, height);
	}
